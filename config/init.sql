...
CREATE TABLE IF NOT EXISTS projects ( id INT AUTO_INCREMENT PRIMARY KEY, creator INT NOT NULL, title TEXT NOT NULL, subtitle TEXT NOT NULL, description TEXT NOT NULL, target DOUBLE DEFAULT '0' NOT NULL, image TEXT NOT NULL, timestamp TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL );
CREATE INDEX projects_users_id_fk ON projects (creator);
...
CREATE TABLE IF NOT EXISTS token_blacklist (token VARCHAR PRIMARY KEY, timestamp TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL );
