CREATE TABLE IF NOT EXISTS pledges ( id INT AUTO_INCREMENT PRIMARY KEY, user INT NOT NULL, project INT NOT NULL, reward INT NULL, amount DOUBLE DEFAULT '0' NOT NULL, anonymous VARCHAR(5) DEFAULT "false" NOT NULL);
